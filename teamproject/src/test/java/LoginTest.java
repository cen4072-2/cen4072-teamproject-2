...
public class LoginTest {
    ...
    @Test
    public void userDoesNotExistAndEmptyPassword_returnsIncorrectPasswordMessage(){
        loginpage = loginpage.signin("sfjsknfjhwuiheirufhwiuehfqwei","");
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        WebElement x = driver.findElement(By.className("field_error"));
        assertEquals("The password you entered was incorrect.",x.getText());
    }

    //Note: DeviantArt usernames may only contain letters, numbers, and hyphens.
    @Test
    public void usernameHasSpecialCharactersAndEmptyPassword_returnsIncorrectPasswordMessage(){
        loginpage = loginpage.signin("@","");
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        WebElement x = driver.findElement(By.className("field_error"));
        assertEquals("The password you entered was incorrect.",x.getText());
    ...
    @Test
    public void UserDoesNotExistAndPasswordIsNotEmpty_returnsIncorrectUsernameOrPasswordMessage(){
        loginpage = loginpage.signin("","fnsjanjnjnfi");
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        WebElement x = driver.findElement(By.className("field_error"));
        assertEquals("The username or password you entered was incorrect.",x.getText());
    }
